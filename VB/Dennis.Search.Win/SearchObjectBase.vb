...
'INSTANT VB NOTE: The variable criteria was renamed since Visual Basic does not handle local variables named the same as class members well:
		Public Sub New(ByVal criteria_Renamed As CriteriaOperator)
			criteriaCore = criteria_Renamed
		End Sub
...
'INSTANT VB NOTE: The variable searchResults was renamed since Visual Basic does not handle local variables named the same as class members well:
'INSTANT VB NOTE: The variable error was renamed since Visual Basic does not handle local variables named the same as class members well:
		Public Sub New(ByVal searchResults_Renamed As ICollection, ByVal error_Renamed As Exception)
			searchResultsCore = searchResults_Renamed
			errorCore = error_Renamed
		End Sub
